...
> [Remote Swagger UI](http://206.189.150.216/api-docs/index.html), alternatively you can run the rails server locally and use the [Local Swagger UI](http://localhost:3000/api-docs/index.html)
> If you're experiencing issues with the Local Swagger UI 127.0.0.1:3000/api-docs/index.html (e.g. CORS policy, LoadError), please use localhost:3000/api-docs/index.html
...
> **Note**: We can retrieve the API key for local env by running `bundle exec rake one_off:retrieve_admin_user_api_key `. The API key for remote env is `4435b3e3731ff72ccecc7745ac604daaf21a4fd9`
